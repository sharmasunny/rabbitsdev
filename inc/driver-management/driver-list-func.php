...
$editdriveremail = $_POST['drivereditemail'];
...
*/
	...
	$sql = "UPDATE ".$drivers_table." SET driver_name='".$editdrivername."' ,driver_email='".$editdriveremail."', driver_zone_id ='".$editdriverzone."' WHERE driver_id=".$editdriverid." ";
